...
def show_case_c():
    ...
    st.markdown("**Packstücke**")
    pieces = []
    for i in range(int(parcel_count)):
        with st.expander(f"Packstück {i + 1}", expanded=(i == 0)):
    ...
    # Wenn EXP-Terminservices gewaehlt sind, ist LZ48 automatisch ausgeschlossen.
